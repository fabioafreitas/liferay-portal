...
public class ContentCoverageResourceTest
	...
	public void testGetProjectContentCoverage() throws Exception {
		_testGetProjectContentCoverageWithEmptyCoverage();
		_testGetProjectContentCoverageWithFullCoverage();
		_testGetProjectContentCoverageWithInvalidProjectId();
		_testGetProjectContentCoverageWithPartialCoverage();
		_testGetProjectContentCoverageWithStatusFiltering();
	}
	...
	private void _assertContentCoverage(
		...
		JSONAssert.assertEquals(
			expectedContentCoverage.toString(), contentCoverage.toString(),
	...
	private void _testGetProjectContentCoverageWithEmptyCoverage()
		throws Exception {

		String assetTagName = "L_CMP_TASK_" + RandomTestUtil.randomString(10);

		ObjectEntry objectEntry = _addObjectEntry(new long[0], assetTagName);
		...
		_assertContentCoverage(
			_toContentCoverage(
				1L, new ContentCoverageEntry[0], new AssetCategory[0],
				new AssetCategory[0]),
			objectEntry);
	}

	private void _testGetProjectContentCoverageWithFullCoverage()
		throws Exception {
		...
		ObjectEntry projectObjectEntry = _addObjectEntry(
			new long[] {
		...
		_addObjectEntry(new long[0], new String[] {assetTagName});
		_addObjectEntry(
			new long[] {
				awarenessAssetCategory.getCategoryId(),
				championAssetCategory.getCategoryId(),
		...
		_assertContentCoverage(
			_toContentCoverage(
				...
				new ContentCoverageEntry[] {
					_toContentCoverageEntry(1L, -1, -1),
					_toContentCoverageEntry(
						1L, -1L, championAssetCategory.getCategoryId()),
					_toContentCoverageEntry(
						1L, -1L, decisionMakerAssetCategory.getCategoryId()),
					_toContentCoverageEntry(
						1L, awarenessAssetCategory.getCategoryId(), -1L),
					_toContentCoverageEntry(
						1L, awarenessAssetCategory.getCategoryId(),
						decisionMakerAssetCategory.getCategoryId()),
					_toContentCoverageEntry(
						1L, considerationAssetCategory.getCategoryId(), -1L),
					_toContentCoverageEntry(
						1L, considerationAssetCategory.getCategoryId(),
						championAssetCategory.getCategoryId()),
					_toContentCoverageEntry(
						1L, considerationAssetCategory.getCategoryId(),
						decisionMakerAssetCategory.getCategoryId()),
					_toContentCoverageEntry(
						2L, awarenessAssetCategory.getCategoryId(),
						championAssetCategory.getCategoryId())
				},
				new AssetCategory[] {
	...
	private void _testGetProjectContentCoverageWithPartialCoverage()
		throws Exception {
		...
		_assertContentCoverage(
			_toContentCoverage(
				2L,
				new ContentCoverageEntry[] {
					_toContentCoverageEntry(1L, -1L, -1L),
					_toContentCoverageEntry(
						1L, awarenessAssetCategory.getCategoryId(), -1L)
				},
	...
	private void _testGetProjectContentCoverageWithStatusFiltering()
		throws Exception {
		...
		_assertContentCoverage(
			_toContentCoverage(
				...
				new ContentCoverageEntry[] {
					_toContentCoverageEntry(
						5L, awarenessAssetCategory.getCategoryId(),
						championAssetCategory.getCategoryId())
				},
				new AssetCategory[] {awarenessAssetCategory},
