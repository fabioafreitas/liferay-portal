...
public class Query {
	 ...
	 *
	 * curl -H 'Content-Type: text/plain; charset=utf-8' -X 'POST' 'http://localhost:8080/o/graphql' -d $'{"query": "query {projectContentCoverage(cmsGroupId: ___, projectId: ___){matrixCells, funnelStages, personas, totalAssetCount}}"}' -u 'test@liferay.com:test'
	 */
	@GraphQLField
...
// LIFERAY-REST-BUILDER-HASH:1730887558