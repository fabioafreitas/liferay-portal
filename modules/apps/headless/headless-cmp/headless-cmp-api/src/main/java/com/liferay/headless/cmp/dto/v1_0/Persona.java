...
public class Persona implements Serializable {
	...
	public Boolean getUncategorized() {
		if (_uncategorizedSupplier != null) {
			uncategorized = _uncategorizedSupplier.get();

			_uncategorizedSupplier = null;
		}
	...
	public void setUncategorized(
		UnsafeSupplier<Boolean, Exception> uncategorizedUnsafeSupplier) {

		_uncategorizedSupplier = () -> {
			try {
				return uncategorizedUnsafeSupplier.get();
			}
			catch (RuntimeException runtimeException) {
				throw runtimeException;
			}
	...
	@GraphQLField
	@JsonProperty(access = JsonProperty.Access.READ_ONLY)
	protected Boolean uncategorized;

	@JsonIgnore
	private Supplier<Boolean> _uncategorizedSupplier;
	...
	public String toString() {
		...
		Boolean uncategorized = getUncategorized();
...
// LIFERAY-REST-BUILDER-HASH:-1518255977