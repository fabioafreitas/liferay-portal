...
public class FunnelStageSerDes {
	...
	public static String toJSON(FunnelStage funnelStage) {
		...
		if (funnelStage.getUncategorized() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(funnelStage.getUncategorized());
		}
	...
	public static Map<String, String> toMap(FunnelStage funnelStage) {
		...
		if (funnelStage.getUncategorized() == null) {
			map.put("uncategorized", null);
		}
		else {
			map.put(
				"uncategorized",
				String.valueOf(funnelStage.getUncategorized()));
		}
	...
	public static class FunnelStageJSONParser
		...
		protected boolean parseMaps(String jsonParserFieldName) {
			...
			else if (Objects.equals(jsonParserFieldName, "uncategorized")) {
				return false;
			}
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "description")) {
				...
				if (jsonParserFieldValue != null) {
					funnelStage.setUncategorized((Boolean)jsonParserFieldValue);
				}
			}
		}
...
// LIFERAY-REST-BUILDER-HASH:1429033918