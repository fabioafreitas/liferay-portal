...
public class WorkflowDefinitionGroovyScriptUsesFactoryTest
	...
	@Test
	public void testHasActiveUses() throws Exception {
		Assert.assertFalse(_groovyScriptUsesFactory.hasActiveUses());
		...
		Assert.assertTrue(_groovyScriptUsesFactory.hasActiveUses());
	}
