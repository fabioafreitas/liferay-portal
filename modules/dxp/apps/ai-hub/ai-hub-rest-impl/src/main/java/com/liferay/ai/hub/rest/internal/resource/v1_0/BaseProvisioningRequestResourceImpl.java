...
public abstract class BaseProvisioningRequestResourceImpl
	 ...
	 *
	 * curl -X 'POST' 'http://localhost:8080/o/ai-hub/v1.0/provisioning' -d $'{"accountExternalReferenceCode": ___, "accountName": ___, "liferayDXPURL": ___, "userAccounts": ___}' --header 'Content-Type: application/json' -u 'test@liferay.com:test'
	 */
...
// LIFERAY-REST-BUILDER-HASH:290949840