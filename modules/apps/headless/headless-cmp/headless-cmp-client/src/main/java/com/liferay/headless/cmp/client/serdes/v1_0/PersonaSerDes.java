...
public class PersonaSerDes {
	...
	public static String toJSON(Persona persona) {
		...
		if (persona.getUncategorized() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(persona.getUncategorized());
		}
	...
	public static Map<String, String> toMap(Persona persona) {
		...
		if (persona.getUncategorized() == null) {
			...
			map.put(
				"uncategorized", String.valueOf(persona.getUncategorized()));
		}
	...
	public static class PersonaJSONParser extends BaseJSONParser<Persona> {
		...
		protected void setField(
			...
			if (Objects.equals(jsonParserFieldName, "description")) {
				...
				if (jsonParserFieldValue != null) {
					persona.setUncategorized((Boolean)jsonParserFieldValue);
				}
			}
		}
...
// LIFERAY-REST-BUILDER-HASH:-808408230