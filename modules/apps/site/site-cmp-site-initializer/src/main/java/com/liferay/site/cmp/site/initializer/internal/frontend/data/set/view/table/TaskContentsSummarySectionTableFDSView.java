 ...
 */
@Component(
	property = "frontend.data.set.name=" + CMPSiteInitializerFDSNames.CMP_TASK_CONTENTS_SUMMARY_SECTION,
	service = FDSView.class
)
public class TaskContentsSummarySectionTableFDSView extends BaseTableFDSView {
