...
public class AgentIssueReportSerDes {
	...
	public static String toJSON(AgentIssueReport agentIssueReport) {
		...
		if (agentIssueReport.getAgentDefinitionExternalReferenceCode() !=
				null) {
		...
		if (agentIssueReport.getCategory() != null) {
			...
			sb.append("\"");
			sb.append(agentIssueReport.getCategory());
			sb.append("\"");
		}
		...
		if (agentIssueReport.getDescription() != null) {
			...
			sb.append(_escape(agentIssueReport.getDescription()));
		...
		if (agentIssueReport.getSurface() != null) {
			...
			sb.append("\"");
			sb.append(agentIssueReport.getSurface());
			sb.append("\"");
		}
	...
	public static Map<String, String> toMap(AgentIssueReport agentIssueReport) {
		...
		if (agentIssueReport.getCategory() == null) {
			...
			map.put("category", String.valueOf(agentIssueReport.getCategory()));
		}
		...
		if (agentIssueReport.getDescription() == null) {
			...
			map.put(
				"description",
				String.valueOf(agentIssueReport.getDescription()));
		}
		...
		protected void setField(
			...
			if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					agentIssueReport.setAgentDefinitionExternalReferenceCode(
						(String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(jsonParserFieldName, "category")) {
				if (jsonParserFieldValue != null) {
					agentIssueReport.setCategory(
						AgentIssueReport.Category.create(
							(String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "dateCreated")) {
				...
				if (jsonParserFieldValue != null) {
					agentIssueReport.setDescription(
						(String)jsonParserFieldValue);
				}
			}
			else if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					agentIssueReport.setSurface(
						AgentIssueReport.Surface.create(
							(String)jsonParserFieldValue));
				}
			}
			else if (Objects.equals(jsonParserFieldName, "traceId")) {
...
// LIFERAY-REST-BUILDER-HASH:-1932524277