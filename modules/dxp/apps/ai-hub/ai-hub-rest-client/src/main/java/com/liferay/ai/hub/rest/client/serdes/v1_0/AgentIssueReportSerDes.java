...
public class AgentIssueReportSerDes {
	...
	public static String toJSON(AgentIssueReport agentIssueReport) {
		...
		if (agentIssueReport.getChatbotExternalReferenceCode() != null) {
			if (sb.length() > 1) {
				sb.append(", ");
			}
			...
			sb.append(
				_escape(agentIssueReport.getChatbotExternalReferenceCode()));
	...
	public static class AgentIssueReportJSONParser
		...
		protected void setField(
			...
			if (Objects.equals(
				...
				if (jsonParserFieldValue != null) {
					agentIssueReport.setChatbotExternalReferenceCode(
...
// LIFERAY-REST-BUILDER-HASH:-336332382